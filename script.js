...
document.getElementById("Credits").onclick = function() {
    ...
    win.document.write("<p>@OfficialAntE - Is a Sikh developer and the founder of team ONLU, and is currently the only developer on team ONLU. He made this website, with no experience in web development. So AI was used to help with the start of the development. Other coding was AntEs work.</p>");
    win.document.close();
    win.document.body.style.backgroundColor = "black";
    win.document.body.style.color = "yellow";   
    win.document.body.style.fontFamily = "Times New Roman, sans-serif";
